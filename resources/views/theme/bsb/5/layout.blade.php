    ...
    <script>
        ...
        function notificacionTodas(id){
            $.ajax({
                dataType: "json",
                method: "get",
                url: "/finanzas/" + id + "/cambio-estado-todo"
        ...
        function limpiarNotificacion(id){
            $.ajax({
                dataType: "json",
                method: "get",
                url: "/finanzas/" + id + "/limpiar-notificaciones"
            }).done(function (mensaje) {
                location.reload();
            });
        }
        function verTodas(id){
            window.location.href = "{{route('notificaciones_finanzas')}}";
        }
    </script>
    @yield('scripts')
</body>
