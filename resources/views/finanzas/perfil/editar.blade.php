                            ...
                            <div>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="actualizar">
                                        <form class="form-horizontal" id="form_validation" action="{{route('actualizar_perfil_cliente')}}" method="POST">
                                            @csrf @method("put")
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="cambio_clave">
                                        <form class="form-horizontal" id="form_validation" action="{{route('actualizar_clave_cliente')}}" method="POST">
                                            @csrf @method("put")
                                            <div class="form-group">
...
@section('scripts')
    <script>
        ...
        $USR_Foto_Perfil.on('change', function () {
            ...
            jQuery.ajax({
                url:"{{route('actualizar_foto_cliente')}}",
                headers: {
