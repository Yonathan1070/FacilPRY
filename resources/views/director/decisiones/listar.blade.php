            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown" style="top:10px;">
                        <li class="dropdown">
                            <a class="btn btn-success waves-effect" href="{{route('crear_decision_director')}}"><i
                ...
                <div class="body table-responsive">
                    @if (count($decisiones)<=0) <div class="alert alert-warning">
                        ...
                        <a href="{{route('crear_decision_director')}}" class="alert-link">Clic aquí para
                            agregar!</a>.
                        </div>
                    @else
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('eliminar_decision_director', ['id'=>$decision->id])}}"
