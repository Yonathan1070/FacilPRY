...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                    <h2>EDITAR DIRECTOR DE PROYECTOS</h2>
                ...
                <div class="body">
                    <form id="form_validation" action="{{route('actualizar_director_administrador', ['id' => $director->id])}}" method="POST">
                        @csrf @method("put")
