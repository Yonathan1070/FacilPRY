                        ...
                        <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                            ...
                            <tr>
                                <td class="agile-main" align="center" style="font-family:'Bell Gothic Std', sans-serif; color: #fefefe; font-size: 20px; line-height: 35px;" class="scale-center-both">
                                     “Haga clic en el botón para reestablecer su contraseña.”
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <table width="380" border="0" cellspacing="0" cellpadding="0" align="left" class="scale">
                                        <tr>
                                            <td class="w3ls-ba" align="right" class="scale-center-bottome-both">
                                                <a href="{{route('cambiar_clave', ['token' => $token])}}" style="font-family:'Candara', sans-serif; color: #fefefe; font-size: 16px; text-decoration: none; background-color: #d20962; padding: 12px 26px 13px 26px; border-radius: 4px;">Recuperar Contraseña</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td bgcolor="#efe9e5" style="background: url({{asset('assets/bsb/images/header-bgtop2.png')}}) center center / cover no-repeat, #efe9e5;">
            <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                <tr>
                        ...
                        <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="agile1 scale">
                            ...
                            <tr>
                                <td class="w3l-p2" style="font-family: Candara, sans-serif; color: #7f8c8d; font-size: 18px; line-height: 28px;" class="scale-center-both">
                                    Para iniciar sesión debe usar su nombre de usuario.<br>
                                    Nombre de Usuario: {{$user->USR_Nombre_Usuario}}
                                </td>
                            </tr>
                        </table>
                    </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td bgcolor="#efe9e5" style="background: url({{asset('assets/bsb/images/footer-bgbtm2.png')}}) center center / cover no-repeat, #efe9e5;">
            <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                <tr>
                                    ...
                                    <table width="170" border="0" cellspacing="0" cellpadding="0" align="left" class="fa1 scale">
                                        <tr>
                                            <td class="agile-main" align="center" style="font-family:'source_sans_proregular', Helvetica, Arial, sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px;" class="scale-center-bottom-both">
                                                <img src="{{asset('assets/bsb/images/1.png')}}" border="0" style="display: inline-block; vertical-align: middle; max-width: 40px; height:24px;" alt="" width="24" editable="true" />&nbsp;&nbsp;<a href="#" style="font-family:'Bell Gothic Std', sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px; text-decoration: none;">Facebook</a>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table width="170" border="0" cellspacing="0" cellpadding="0" align="left" class="fa2 scale">
                                                    <tr>
                                                        <td class="agile-main" align="center" style="font-family:'source_sans_proregular', Helvetica, Arial, sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px;" class="scale-center-bottom-both">
                                                            <img src="{{asset('assets/bsb/images/2.png')}}" border="0" style="display: inline-block; vertical-align: middle; max-width: 40px; height:24px;" alt="" width="24" editable="true" />&nbsp;&nbsp;<a href="#" style="font-family:'Bell Gothic Std', sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px; text-decoration: none;">Twitter</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table width="170" border="0" cellspacing="0" cellpadding="0" align="right" class="fa3 scale">
                                                    <tr>
                                                        <td class="agile-main" align="center" style="font-family:'source_sans_proregular', Helvetica, Arial, sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px;" class="scale-center-both">
                                                            <img src="{{asset('assets/bsb/images/3.png')}}" border="0" style="display: inline-block; vertical-align: middle; max-width: 40px; height:24px" alt="" width="24" height:24pxeditable="true" />&nbsp;&nbsp;<a href="#" style="font-family:'Bell Gothic Std', sans-serif; color: #FFFFFF; font-size: 20px; line-height: 20px; text-decoration: none;">Google +</a>
                                                        </td>
                                                    </tr>
                                                </table>
