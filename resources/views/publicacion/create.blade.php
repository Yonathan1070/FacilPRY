            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown" style="top:10px;">
                        <li class="dropdown">
                            <a class="btn btn-danger waves-effect" href="{{route('publicacion',$parrilla->id)}}">
                ...
                <div class="body">
                    <form id="form_validation" action="{{route('guardar_publicacion')}}" method="POST">
                        @csrf
                        @include('publicacion.form')
                        <a class="btn btn-danger waves-effect" href="{{route('publicacion',$parrilla->id)}}">CANCELAR</a>
