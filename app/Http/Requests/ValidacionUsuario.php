...
class ValidacionUsuario extends FormRequest
{
    ...
    {
        return [
            'USR_Documento_Usuario' => 'required|max:50|unique:TBL_Usuarios,USR_Documento_Usuario,' . $this->route('id'),
            ...
            'USR_Correo_Usuario' => 'required|max:100|unique:TBL_Usuarios,USR_Correo_Usuario,' . $this->route('id'),
